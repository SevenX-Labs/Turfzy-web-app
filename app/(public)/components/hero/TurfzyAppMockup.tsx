...
export default function TurfzyAppMockup() {
  return (
    <div className="relative w-full max-w-[170px] sm:max-w-[185px] md:max-w-[200px] lg:max-w-[215px] mx-auto flex items-center justify-center select-none py-1">
      {/* ── Soft Ambient Glow behind phone ── */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[210px] h-[300px] bg-gradient-to-tr from-[#7ED321]/22 via-emerald-400/15 to-transparent blur-[50px] -z-10 rounded-full pointer-events-none" />

      {/* ── REALISTIC PHONE CHASSIS (Hosting Real App Screenshot) ── */}
      <div className="relative w-full aspect-[9/19.5] rounded-[30px] sm:rounded-[34px] border-[6px] sm:border-[8px] border-[#151515] bg-[#151515] shadow-[0_18px_45px_-10px_rgba(0,0,0,0.22),0_8px_24px_rgba(126,211,33,0.15)] overflow-hidden">
