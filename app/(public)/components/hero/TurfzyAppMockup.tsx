...
export default function TurfzyAppMockup() {
  return (
    <div className="relative w-full max-w-[195px] sm:max-w-[210px] md:max-w-[225px] lg:max-w-[235px] xl:max-w-[245px] mx-auto flex items-center justify-center select-none">
      ...
      <div className="relative w-full aspect-[9/19.5] rounded-[30px] sm:rounded-[34px] border-[6px] sm:border-[8px] border-[#151515] bg-[#151515] shadow-[0_16px_40px_-10px_rgba(0,0,0,0.22),0_8px_24px_rgba(126,211,33,0.15)] overflow-hidden">
